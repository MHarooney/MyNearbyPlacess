...
import com.example.chamatestapp.Helper.DirectionJSONParser;
...
public class ViewDirections extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void buildLocationCallBack() {
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                //Create Markerfor destination location
    ...
    private void drawPath(Location mLastLocation, com.example.chamatestapp.Model.Location location) {
        //Clear all polyline
        if (polyline != null)
            polyline.remove();
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... strings) {
            ...
            try {
                ...
                routes = parser.parseFeed(jsonObject);
